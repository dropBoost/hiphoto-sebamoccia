  ...
  return (
    <div className="flex flex-col justify-between items-center bg-brand h-screen w-screen ">
      ...
      <div className="flex lg:flex-row flex-col justify-center items-center h-[30vh] gap-5">
        ...
        <div className="flex flex-col justify-center items-center border p-5 h-full rounded-xl bg-brand-dark/30">
        <Image src={'/logo-fullwhite.png'} width={150} height={200}/>
        <hr className="border border-brand-light w-full mb-5" />
